    ...
    <main>
        <ul class="space-y-4">
            ...
            if (isset($_GET['id_curso'])) {
                ...
                $stmt = $conn->prepare("SELECT id, nome, link_aula, video, curso_id FROM aulas WHERE curso_id = :id_curso");
...
foreach ($aulas as $aula) {
    ...
    echo "<li class='hover:bg-gray-200 p-2 rounded transition duration-300'>
            <a href='aulasUser.php?id_curso=" . $id_curso . "&aula_id=" . $aula['id'] . "&link_aula=" . urlencode($link_aula) . "' class='block'>$nome_aula</a>";
