...
if (!isset($_SESSION['usuario_id'])) {
    echo "Você precisa fazer login para realizar uma compra.";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['id_curso']) && isset($_POST['preco_curso'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO compra (curso_id, usuario_id) VALUES (:curso_id, :usuario_id)");
        ...
        echo "Compra realizada com sucesso! Acesse seu curso agora.";
    } else {
