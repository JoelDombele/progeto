<?php
session_start();
include '../view/instrutor.view.php';
?>
...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div class="flex justify-center">
            <a href="formCurso.view.php" class="inline-flex items-center px-6 py-3 bg-green-500 text-white rounded-md hover:bg-green-600 focus:bg-green-600 focus:outline-none focus:shadow-outline-green active:bg-green-700">
